...
<section id="wrap">
	<section id="content">
		<section class="text-content">
			...
			<p>A festa vai rolar no dia <strong class="highlight">02/11/2019 às 20h</strong> e você é meu convidado. Clique abaixo na sua opção e siga as instruções.</p>

			<p>Well, are you ready, Ray? </p>
		
			<button class="btn bred" onclick="location.href='{{ url('/quest') }}'">Confirmar Presença</button>
			<button class="btn bgray" onclick="location.href='{{ route('out') }}'">Não Posso Comparecer</button>	
		</section>	
	</section>	
</section>
@endsection